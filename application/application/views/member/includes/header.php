            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <?php } ?>
                  <span class="hidden-xs"><?php echo $this->session->userdata('pgw_nama'); ?></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <?php if($jk=='L' && $foto == 'default.jpg'){ ?>
                      ...
                      <?php } ?>
                    <p>
                      <?php echo $this->session->userdata('pgw_nama'); ?>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url(); ?>member/user/loadChangePass" class="btn btn-default btn-flat"><i class="fa fa-key"></i> Change Password</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url(); ?>member/user/logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
