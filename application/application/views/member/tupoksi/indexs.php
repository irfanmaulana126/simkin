              ...
              <table class="table table-borderedr">
               ...
               <?php if(!empty($Kuantitas))
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="<?= base_url('/member/tupoksi/cetak_detail_tupoksi_folio/').$record->usr_id."/".$record->id."/".$dates."/".$record->id_unit_kerja?>" target="_blank" rel="noopener noreferrer"><?= $record->sumall;$d+=$record->sumall ?></a></td>
                  <?php }else if($record->jns_input=='1'){ ?>
                  <td class="text-center"><a href="<?= base_url('/member/tupoksi/cetak_detail_tupoksi_tindakan/').$record->usr_id."/".$record->id."/".$dates."/".$record->id_unit_kerja?>" target="_blank" rel="noopener noreferrer"><?= $record->sumall;$d+=$record->sumall ?></a></td>
                  <?php }else{ ?>
