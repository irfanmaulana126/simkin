                ...
                <div class="box-body table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $record->klinik_kategori_tindakan_header_instalasi_nama ?></td>
                      <td><?php echo $record->kategori_tindakan_header_nama ?></td>
                      <td><?php echo $record->kategori_tindakan_nama ?></td>
