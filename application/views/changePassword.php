            ...
            <div class="col-md-4">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <?php if($role_text == 'PIMPINAN'){ ?>
                    <form role="form" action="<?php echo base_url() ?>admin/user/changePassword" method="post">
                    <?php }else{ ?>
                    <form role="form" action="<?php echo base_url() ?>member/user/changePassword" method="post">
                    <?php } ?>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
